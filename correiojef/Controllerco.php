...
$Correios=new classco();
$Correios->precoprazo($CepOrigem,$CepDestino,$Peso,$Formato,$Comprimento,$Altura,$Largura,$Maopropria,$ValorDeclarado,$AvisoRecebimento,$Codigo,$Diametro);