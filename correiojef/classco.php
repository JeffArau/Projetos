...
class classco{
	...
	public $Retorno;
	//pesquisa de preço e przo
	public function precoprazo($CepOrigem,$CepDestino,$Peso,$Formato,$Comprimento,$Altura,$Largura,$MaoPropria,$ValorDeclarado,$AvisoRecebimento,$Codigo,$Diametro){
